...
function submitTransaction() {
    return __awaiter(this, void 0, void 0, function () {
        var walletPath, wallet, gateway, connectionProfilePath, connectionProfile, connectionOptions, network, contract, results, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 5, , 6]);
                    walletPath = path.join(process.cwd(), 'org0.example.com');
                    return [4 /*yield*/, fabric_network_1.Wallets.newFileSystemWallet(walletPath)];
                case 1:
                    wallet = _a.sent();
                    console.log("Wallet path: " + walletPath);
                    gateway = new fabric_network_1.Gateway();
                    connectionProfilePath = path.resolve(__dirname, '..', 'Test2GwConnection.json');
                ...
                case 3:
                    ...
                    return [4 /*yield*/, contract.evaluateTransaction('QuerryAllAssets')];
                case 4:
                    results = _a.sent();
